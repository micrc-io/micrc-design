...
import { MicrcWebClientendAspect } from './micrc-web-clientend.aspect';

export class MicrcWebClientendMain {
  static slots = [];
...
`,
    ...
    return new MicrcWebClientendMain();
  }
}

MicrcWebClientendAspect.addRuntime(MicrcWebClientendMain);

...
import { MicrcAppModuleAspect } from './micrc-app-module.aspect';

export class MicrcAppModuleMain {
  static slots = [];
...
`,
    ...
    return new MicrcAppModuleMain();
  }
}

MicrcAppModuleAspect.addRuntime(MicrcAppModuleMain);

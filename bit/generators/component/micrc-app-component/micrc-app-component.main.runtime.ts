...
import { MicrcAppComponentAspect } from './micrc-app-component.aspect';

export class MicrcAppComponentMain {
  static slots = [];
...
`,
    ...
    return new MicrcAppComponentMain();
  }
}

MicrcAppComponentAspect.addRuntime(MicrcAppComponentMain);

...
import { MicrcMiniClientendAspect } from './micrc-mini-clientend.aspect';

export class MicrcMiniClientendMain {
  static slots = [];
...
`,
    ...
    return new MicrcMiniClientendMain();
  }
}

MicrcMiniClientendAspect.addRuntime(MicrcMiniClientendMain);

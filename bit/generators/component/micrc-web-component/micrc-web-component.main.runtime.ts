...
import { MicrcWebComponentAspect } from './micrc-web-component.aspect';

export class MicrcWebComponentMain {
  static slots = [];
...
`,
    ...
    return new MicrcWebComponentMain();
  }
}

MicrcWebComponentAspect.addRuntime(MicrcWebComponentMain);

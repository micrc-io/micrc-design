...
import { MicrcWebModuleAspect } from './micrc-web-module.aspect';

export class MicrcWebModuleMain {
  static slots = [];
...
`,
    ...
    return new MicrcWebModuleMain();
  }
}

MicrcWebModuleAspect.addRuntime(MicrcWebModuleMain);

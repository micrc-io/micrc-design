...
import { MicrcMiniModuleAspect } from './micrc-mini-module.aspect';

export class MicrcMiniModuleMain {
  static slots = [];
...
`,
    ...
    return new MicrcMiniModuleMain();
  }
}

MicrcMiniModuleAspect.addRuntime(MicrcMiniModuleMain);

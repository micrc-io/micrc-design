...
import { MicrcAppClientendAspect } from './micrc-app-clientend.aspect';

export class MicrcAppClientendMain {
  static slots = [];
...
`,
    ...
    return new MicrcAppClientendMain();
  }
}

MicrcAppClientendAspect.addRuntime(MicrcAppClientendMain);

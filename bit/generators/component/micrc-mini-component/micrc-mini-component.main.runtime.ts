...
import { MicrcMiniComponentAspect } from './micrc-mini-component.aspect';

export class MicrcMiniComponentMain {
  static slots = [];
...
`,
    ...
    return new MicrcMiniComponentMain();
  }
}

MicrcMiniComponentAspect.addRuntime(MicrcMiniComponentMain);

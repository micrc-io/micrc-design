...
import styles from './authc-generic-layout-tmp.module.scss';

export type AuthcGenericLayoutTmpProps = {
  logo?: ReactElement;
...
export function AuthcGenericLayoutTmp(props: AuthcGenericLayoutTmpProps) {
...
AuthcGenericLayoutTmp.defaultProps = {
  logo: (
    <>

  ...
  try {
    ...
    await execCmd(
      ...
      [
        ...
        '--source',
        `${repo}/${SCHEMA_BRANCH}`,
        `schema/${contextName}/design`,
      ],
      gitBasePath,
    );
    // 获取schema目录当前上下文/system文件夹
    await execCmd(
      'git',
      [
        'restore',
    ...
    await execCmd(
      ...
      [
        ...
        '--source',
        `${repo}/${SCHEMA_BRANCH}`,
        `schema/${contextName}/aggregations`,
      ],
      gitBasePath,
    );
    // 拉取当前用例的协议文件
    await execCmd(
      ...
      [
        ...
        '--source',
        `${repo}/${SCHEMA_BRANCH}`,
        `schema/${contextName}/cases/${branch}`,
      ],
      gitBasePath,
    );
    // 添加合并的文件
